...
namespace AForge.Imaging.Filters
{
    ...
    /// </remarks>
    /// 
    public class AreaComponentsLabeling : BaseFilter
    {
        // Color table for coloring objects
        private static Color[] colorTable = new Color[]
		{ Color.LimeGreen, Color.Yellow, Color.Red };
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AreaComponentsLabeling"/> class.
        /// </summary>
        /// 
        public AreaComponentsLabeling( )
        {
